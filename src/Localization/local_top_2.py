...
local = localize(camera=1, players=2, verbose=False, Team=2) # set camera=0 if no USB camera, 1 if USB camera, verbose for showing live camera feed during detection
local.detect()